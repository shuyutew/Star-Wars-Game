 ...
 */
public class Heal extends SWAffordance implements SWActionInterface {
	 ...
	 */
	public Heal(SWEntityInterface theTarget, MessageRenderer m) {
		super(theTarget, m);	
		priority = 1;
	}
	...
	public String getDescription() {
		return "heal " + this.target.getShortDescription();
	}
	...
	public void act(SWActor a) {
		...
		if (itemCarried != null) {//if the actor is carrying an item 
			if (itemCarried.hasCapability(Capability.DRINKABLE)) {
